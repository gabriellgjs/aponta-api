...
export default class PermissionsRoutes {
  ...
  public async routes() {
    const getPermission = this.permissionsController.getPermission.bind(this.permissionsController);

    const getPermissions = this.permissionsController.getPermissions.bind(this.permissionsController);
